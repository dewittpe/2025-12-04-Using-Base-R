...
## For 10 patients
```{r, echo = FALSE}
knitr::include_graphics("benchmarks_n10.png")
```

## For 100 patients
```{r, echo = FALSE}
knitr::include_graphics("benchmarks_n100.png")
```

## For 1,000 patients
```{r, echo = FALSE}
knitr::include_graphics("benchmarks_n1000.png")
```

## For 10,000 patients
```{r, echo = FALSE}
knitr::include_graphics("benchmarks_n10000.png")
```

## For 100,000 patients
```{r, eval = FALSE, echo = FALSE}
knitr::include_graphics("benchmarks_n100000.png")
```
